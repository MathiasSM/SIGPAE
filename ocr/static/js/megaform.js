$(document).ready(function () {
  ...
  function anadirUnaReferencia(num1){
    ...
    autorCount[num1-1] = autorCount[num1-1].concat([0]);
  ...
  function anadirUnaSeccion(){
    ...
    referenciaCount = referenciaCount.concat([0]);  // Agregar un nuevo slot contador de referencias
